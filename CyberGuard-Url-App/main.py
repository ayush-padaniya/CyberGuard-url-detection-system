...
def extract_features(url: str) -> dict:
    ...
    # Approximate live-site security features without making slow network calls.
    if features['https']:
    ...
    # Phishing and malicious URL signals.
...
# prediction history for dashboard
prediction_history = []
...
async def predict(request: Request, url: str = Form(...)):
    try:
        ...
        # Hybrid policy handles clear live-URL cases before ML fallback.
